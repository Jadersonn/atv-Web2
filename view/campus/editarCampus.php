...
<body>
    ...
    <div class="container">
        ...
        <form action="<?php echo $path; ?>/repositorio/campus/editarCampus.php" method="POST">
            <input value="<?php echo $linha['idCampus'] ?>" type="text" name="idCampus" id="idCampus" hidden alt="Passando a identificação do Campus que vai ser editado">
            <div class="row mb-3">
                <div class="col col-md-8">
                    <label class="form-label" for="idnome">Nome</label>
                    <input class="form-control" value="<?php echo $linha['nomeCampus'] ?>" type="text" name="nome"
                        id="idnome" alt="Novo nome para o Campus">
                </div>
                <div class="col col-md-4">
                    <label class="form-label" for="idcep">CEP</label>
                    <input class="form-control" value="<?php echo $linha['CEP'] ?>" type="number" name="cep" id="idcep" alt="Editando o CEP do antigo Campus">
                </div>
            </div>
            <?php 
                }
