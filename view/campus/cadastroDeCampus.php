        ...
        <form action="<?php echo $path; ?>/repositorio/campus/salvarCampus.php" method="POST">
            <div class="row mb-3">
                <div class="col col-md-8">
                    ...
                    <input class="form-control" type="text" name="nome" id="idnome" alt="Nome do Campus que deseja cadastrar">
                </div>
            ...
            <div class="row mb-3">
                ...
                <div class="col col-md-3">
                    ...
                    <input class="form-control" type="text" name="cidade" id="idcidade" alt="Cidade onde se encontra o campus que vai ser cadastrado">
                </div>
                <div class="col col-md-1">
                    <label class="form-label" for="iduf">UF</label>
                    <input class="form-control" type="text" name="uf" id="iduf" alt="Estado onde o campus vai ser cadastrado">
                </div>
            </div>
